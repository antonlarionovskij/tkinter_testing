...
txt_one = Label(window, text='Обнаружен неучтенный USB-накопитель!!!', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
txt_two = Label(window, text='Ваш компьютер был заблокирован. :(', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
txt_three = Label(window, text='Для получения доступа к компьютеру обратитесь к специалисту по информационной безопасности.', font=("Arial Bold", fontsize), fg='white', bg='black')
...
txt = Entry(window)
btn = Button(window, text="ВВОД КОДА РАЗБЛОКИРОВКИ", command=clicked)
